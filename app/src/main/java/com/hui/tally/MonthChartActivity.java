...
//        将Fragment加载到Acitivy当中
    ...
    private void initStatistics(int year, int month) {
        ...
        dateTv.setText("Bill for " + year + "/" + month);
        inTv.setText(incountItemOneMonth + " income records, $ " + inMoneyOneMonth);
        outTv.setText(outcountItemOneMonth + " expense records, $ " + outMoneyOneMonth);
